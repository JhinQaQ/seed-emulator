...
e1.setBootNode(True).setMode("light").setBootNodeHttpPort(8081).startMiner()
e2.setBootNode(True).setMode("light").startMiner()
# e3.setMode("light").startMiner()
# e4.setMode("light").startMiner()

# Create more accounts on e5 and e6
e5.setMode("light").startMiner().createNewAccount(4)
